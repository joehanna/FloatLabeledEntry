...
namespace FLEDemo.iOS
{
  public class MainViewController : UIViewController
  {
    ...
    public override void ViewDidLoad()
    {
      ...
      UIColor floatingLabelColor = UIColor.Gray, floatingLabelActiveColor = UIColor.FromRGB(79, 194, 159);

      var titleField = new FloatLabeledTextField(new CGRect(FieldHMargin,
                                                            topOffset,
